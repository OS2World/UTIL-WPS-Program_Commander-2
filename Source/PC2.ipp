...
:li.:link reftype=hd res=&ID_CONFIGDIALOG..<Setup dialog>:elink. (Setting up the Popup Menu)
:ul compact.
:li.:link reftype=hd res=&MIID_MENUDIALOG..<Menu Installation dialog>:elink. (Adding a Submenu)
:li.:link reftype=hd res=&PIID_PROGRAMDIALOG..<Program Installation dialog>:elink. (Adding a Program)
:li.:link reftype=hd res=&MDID_CONTROLDIALOG..<Control Addition dialog>:elink. (Adding Menucontrols)
:li.:link reftype=hd res=&CCID_CONTROLDIALOG..<Control Configuration dialog>:elink. (Changing Popup Menucontrols)
:li.:link reftype=hd res=&RDID_RESORTDIALOG..<Resort dialog>:elink. (Resorting a (Sub)menu)
:li.:link reftype=hd res=&SEID_STARTUPDIALOG..<Startup Environment Spaces dialog>:elink. (Runtime Environment Spaces)
:li.:link reftype=hd res=&SUID_STARTUPDIALOG..<Startup Parameters dialog>:elink. (Runtime (Commandline) Parameters)
:eul.
:li.:link reftype=hd res=&ID_DESKTOPDIALOG..<Desktop Configuration dialog>:elink. (Setting up the Desktop)
:li.:link reftype=hd res=&ID_OVERVIEWHELP..<PC/2's Overview Window>:elink.
:li.:link reftype=hd res=&ID_PC2SPOOLERWINDOW..<PC/2's Spooler Control Window>:elink.
:li.:link reftype=hd res=&ID_PC2SWITCHWINDOW..<PC/2's QuickSwitch Window>:elink.
:li.:link reftype=hd res=&ID_PC2SESSIONWINDOW..<PC/2's SessionBar Window>:elink.
:li.:link reftype=hd res=&ID_COMPATIBILITY..<PC/2's compatibility to other applications>:elink.
:li.:link reftype=hd res=&ID_BUGS..<PC/2's known problems>:elink.
:li.:link reftype=hd res=&ID_ERRORHELP..<Error Messages>:elink.
:li.:link reftype=hd res=&ID_FAQ1..<Questions &amp. Answers (part 1)>:elink.
:li.:link reftype=hd res=&ID_FAQ2..<Questions &amp. Answers (part 2)>:elink.
:li.:link reftype=hd res=&ID_FAQ3..<Questions &amp. Answers (part 3)>:elink.
:li.:link reftype=hd res=&ID_TRAPINFO..<PC/2 hang/trap/bug diagnostics>:elink.
:li.:link reftype=hd res=&ID_TECHINFO..<Technical background information>:elink.
...
.* :p.:link reftype=hd res=&ID_SURVEY..<Backward>:elink.
:p.:link reftype=hd res=&ID_TECHINFO..<Backward>:elink.
...
:h1 res=&ID_ABOUTDIALOG..Help for About PC/2 dialog
:lines align=center.
:color fc=red.
PC/2 - Program Commander/2 Version 2.20
for IBM OS/2 2.x, WARP, WARP Srv. SMP, Aurora Presentation Manager
...
:link reftype=hd res=&DDID_PAGE1A..<Virtual Desktop Settings>:elink. dialog.
:warning text="Note!".
...
:h1 res=&ID_CONFIGDIALOG..Help for PC/2 Setup dialog
...
:link reftype=hd res=&CCID_CONTROLDIALOG..<Control Configuration>:elink..
...
:link reftype=hd res=&ID_CONFIGDIALOG..<PC/2 Setup>:elink. dialog (which
...
:link reftype=hd res=&PIID_PAGE6..<Environment Spaces>:elink. for more than
one item simultaneously (the
:link reftype=hd res=&PIID_PROGRAMDIALOG..<Program Installation Dialog>:elink.
...
:link reftype=hd res=&DDID_PAGE8A..<Managing Environment Spaces>:elink..
:dl tsize=12 break=fit.
:dthd.:hp4.Pushbutton&colon.
:ddhd.Description&colon.:ehp4.
:dt.:hp9.Add:ehp9.
...
:h1 res=&MIID_MENUDIALOG..Help for PC/2 Menu Installation dialog
...
:dt.:hp9.:link reftype=hd res=&MIID_PAGE1..<Submenu>:elink.:ehp9.
...
:link reftype=hd res=&DDID_PAGE1A..<icons in the Popup Menu>:elink.) is loaded from
that file.
...
:h1 res=&PIID_PROGRAMDIALOG..Help for PC/2 Program Installation dialog
...
:dthd.:hp4.Page&colon.
:ddhd.Tab title&colon.:ehp4.
:dt.:hp9.:link reftype=hd res=&PIID_PAGE1..<Application>:elink.:ehp9.
...
:dt.:hp9.:link reftype=hd res=&PIID_PAGE2..<Session>:elink.:ehp9.
:dd.This page determines the type of session you want to add. Select
between PM, OS/2, DOS and WIN-OS2 sessions.
:dt.:hp9.:link reftype=hd res=&PIID_PAGE3..<Style>:elink.:ehp9.
...
to configure
:dt.:hp9.:link reftype=hd res=&PIID_PAGE4..<Hotkey>:elink.:ehp9.
...
:ewarning.
:dt.:hp9.:link reftype=hd res=&PIID_PAGE5..<Priority>:elink.:ehp9.
...
:ewarning.
:dt.:hp9.:link reftype=hd res=&PIID_PAGE6..<Environment>:elink.:ehp9.
...
PC/2's Popup Menu.
:dt.:hp9.:link reftype=hd res=&PIID_PAGE7..<Scheduler>:elink.:ehp9.
...
:li.:link reftype=hd res=&PIID_PAGE7..<Scheduler Settings>:elink.
:eul.
...
Please read about :link reftype=hd res=&DDID_PAGE8A..<Managing Environment Spaces>:elink..
and :link reftype=hd res=&PIID_PAGE6..<specifying an application's Environment>:elink.
...
:link reftype=hd res=&PIID_PAGE2..<Session Settings>:elink. about detached
sessions.
...
:p.Press :hp4.Ok:ehp4. to accept, or press :hp4.Cancel:ehp4. to ignore the data
you entered in all notebook pages.
:p.:link reftype=hd res=&PIID_PROGRAMDIALOG..<Return to dialog help>:elink.
...
:link reftype=hd res=&DDID_PAGE7..<Security>:elink. notebook page.
...
at the :link reftype=hd res=&PIID_PAGE4..<Hotkey>:elink. page is filled correctly.
:edl.
...
systemwide Hotkeys:ehp9. on the :link reftype=hd res=&DDID_PAGE5..<General PC/2
...
class name by using PC/2's :link reftype=hd res=&DDID_PAGE10..<Spy>:elink. notebook
...
just use the :link reftype=hd res=&DDID_PAGE10..<Spy>:elink. notebook page.
:ewarning.
:warning text='Hint:'.
...
:link reftype=hd res=&DDID_PAGE2..<Overview Window Settings>:elink.
...
:link reftype=hd res=&DDID_PAGE2..<Overview Window Settings>:elink. during initialization
of PC/2.
...
:link reftype=hd res=&DDID_PAGE8A..<Environment Spaces>:elink. in your Environment.
...
PC/2 will then invoke the :link reftype=hd res=&SEID_STARTUPDIALOG..<Startup Environment
...
:link reftype=hd res=&DDID_PAGE1A..<Icons>:elink. in the Popup Menu.
...
.*--------------------------------------------------------------------------------------*
:h2 res=&PIID_PAGE7..Scheduler Settings
...
:h1 res=&MDID_CONTROLDIALOG..Help for PC/2 Control Addition dialog
...
from PC/2's :link reftype=hd res=&ID_OVERVIEWHELP..<Smarticons>:elink. instead.
...
:link reftype=hd res=&ID_CONFIGDIALOG..<Setup dialog>:elink. will
...
In the :link reftype=hd res=&DDID_PAGE5..<ShutDown Options>:elink. you may select
...
:link reftype=hd res=&PIID_PAGE7..<Scheduler>:elink..
:dt.:hp9.PowerDown OS/2:ehp9.
:dd.This button adds a Menucontrol, which allows you to suspend or power off your
workstation.
In the :link reftype=hd res=&DDID_PAGE5..<PowerDown Options>:elink. you may select
...
:link reftype=hd res=&DDID_PAGE5..<Automatic PowerDown Timer>:elink. to suspend or
...
the Popup Menu.
Please refer to the :link reftype=hd res=&DDID_PAGE4..<Physical Desktop Settings>:elink.
...
the Popup Menu.
Please refer to the :link reftype=hd res=&DDID_PAGE7..<Security Settings>:elink. for
...
:p.:link reftype=hd res=&PIID_PROGRAMDIALOG..<Backward>:elink.
                                :link reftype=hd res=&CCID_CONTROLDIALOG..<Forward>:elink.
...
:h1 res=&CCID_CONTROLDIALOG..Help for PC/2 Control Configuration dialog
...
:ul compact.
:li.:link reftype=hd res=&CCID_PAGE1..<Current Control>:elink.
:li.:link reftype=hd res=&CCID_PAGE2..<Scheduler Settings>:elink.
:eul.
:p.Press :hp4.Ok:ehp4. to accept or press :hp4.Cancel:ehp4. to ignore your modifications.
...
.*--------------------------------------------------------------------------------------*
:h2 res=&CCID_PAGE1..Current Control
...
:link reftype=hd res=&ID_CONFIGDIALOG..<PC/2 Setup>:elink. dialog
...
:h1 res=&RDID_RESORTDIALOG..Help for PC/2 Resort dialog
...
:ewarning.
:p.:link reftype=hd res=&CCID_CONTROLDIALOG..<Backward>:elink.
                                :link reftype=hd res=&SEID_STARTUPDIALOG..<Forward>:elink.

.*--------------------------------------------------------------------------------------*
.* The user selected help from the Startup Parameters dialog box.                       *
.*--------------------------------------------------------------------------------------*

:h1 res=&SEID_STARTUPDIALOG..Help for PC/2 Startup Environment Spaces dialog
...
the :link reftype=hd res=&PIID_PAGE6..<Program Installation>:elink. dialog
...
:h1 res=&SUID_STARTUPDIALOG..Help for PC/2 Startup Parameters dialog
...
:p.:link reftype=hd res=&SEID_STARTUPDIALOG..<Backward>:elink.
...
:h1 res=&ID_DESKTOPDIALOG..Help for PC/2 Desktop Configuration dialog
...
:link reftype=hd res=&ID_OVERVIEWHELP..<PC/2's Overview Window>:elink., to understand
...
hyperlinks:
:ul compact.
:li.:link reftype=hd res=&DDID_PAGE1A..<Virtual Desktop Settings Page 1>:elink.
:li.:link reftype=hd res=&DDID_PAGE1B..<Virtual Desktop Settings Page 2>:elink.
:li.:link reftype=hd res=&DDID_PAGE2..<Overview Window Settings>:elink.
:li.:link reftype=hd res=&DDID_PAGE3..<SessionBar Settings>:elink.
:li.:link reftype=hd res=&DDID_PAGE4..<Physical Desktop Settings>:elink.
:li.:link reftype=hd res=&DDID_PAGE5..<General PC/2 Settings>:elink.
:li.:link reftype=hd res=&DDID_PAGE6..<SmartIcons Settings>:elink.
:li.:link reftype=hd res=&DDID_PAGE7..<Security Settings>:elink.
:li.:link reftype=hd res=&DDID_PAGE8A..<Environment Spaces Settings Page 1>:elink.
:li.:link reftype=hd res=&DDID_PAGE8B..<Environment Spaces Settings Page 2>:elink.
:li.:link reftype=hd res=&DDID_PAGE9..<Registration Settings>:elink.
:li.:link reftype=hd res=&DDID_PAGE10..<Spy Window Settings>:elink.
:eul.
...
.* notebook page 1.                                                                     *
.*--------------------------------------------------------------------------------------*
:h2 res=&DDID_PAGE1A..Virtual Desktop Settings Page 1
:p.This page is used to control the Virtual Desktop feature of PC/2.
Click :link reftype=hd res=&DDID_PAGE1B..<here>:elink. to switch to the second page.
:dl tsize=12 break=fit.
:dthd.:hp4.Fieldname&colon.
:ddhd.Description&colon.:ehp4.
...
:link reftype=hd res=&PIID_PAGE1..<Executable entryfield>:elink., or
:li.the fully qualified path comprising ot the
:link reftype=hd res=&PIID_PAGE1..<Workdirectory and the Executable>:elink., or
:li.each directory specified in the PATH environment variable for a Menuentry's
:link reftype=hd res=&PIID_PAGE6..<Session Environment>:elink., or
...
:link reftype=hd res=&PIID_PAGE6..<Session's Environment>:elink. and about
:link reftype=hd res=&DDID_PAGE8A..<Environment Spaces>:elink., if
...
:p.:link reftype=hd res=&ID_DESKTOPDIALOG..<Return to dialog help>:elink.

.*--------------------------------------------------------------------------------------*
.* The user selected help from the Desktop Configuration Virtual Desktop Settings       *
.* notebook page 2.                                                                     *
.*--------------------------------------------------------------------------------------*
:h2 res=&DDID_PAGE1B..Virtual Desktop Settings Page 2
:p.This page is used to control the Virtual Desktop feature of PC/2.
Click :link reftype=hd res=&DDID_PAGE1A..<here>:elink. to switch to the first page.
:dl tsize=12 break=fit.
:dthd.:hp4.Fieldname&colon.
:ddhd.Description&colon.:ehp4.
...
Please refer to :link reftype=hd res=&ID_FAQ3..<PC/2's Frequently Asked Questions>:elink.
...
When using the :link reftype=hd res=&DDID_PAGE10..<Spy Window Settings>:elink. of the
...
.* notebook page.                                                                       *
.*--------------------------------------------------------------------------------------*
:h2 res=&DDID_PAGE2..Overview Window Settings
:p.PC/2's :link reftype=hd res=&ID_OVERVIEWHELP..<Overview Window>:elink. is the main
entrypoint of Program Commender/2.
This notebook page allows you to customize the appearance according to your preferences.
:p.Just a few words about the :link reftype=hd res=&ID_OVERVIEWHELP..<Overview Window>:elink..
...
:link reftype=hd res=&DDID_PAGE1A..<Virtual Desktop Settings>:elink. page 1.
:ewarning.
:dt.:hp9.Delay:ehp9.
...
at :link reftype=hd res=&PIID_PAGE4..<Hotkey>:elink. notebook pages.
...
:link reftype=hd res=&PIID_PAGE4..<Hotkey Settings>:elink. of an Menuentry during initialization
of PC/2.
...
.* page.                                                                                *
.*--------------------------------------------------------------------------------------*
:h2 res=&DDID_PAGE3..SessionBar Settings
:p.The :link reftype=hd res=&ID_PC2SESSIONWINDOW..SessionBar:elink. is window that allows
...
The :link reftype=hd res=&ID_PC2SESSIONWINDOW..SessionBar:elink.
...
:link reftype=hd res=&ID_PC2SESSIONWINDOW..<SessionBar>:elink., which gives you an
...
The :link reftype=hd res=&ID_PC2SESSIONWINDOW..<SessionBar>:elink. shows you how
...
:dd.This checkbox allows you to activate PC/2's
:link reftype=hd res=&ID_PC2SWITCHWINDOW..<QuickSwitch>:elink. window, which allows you
...
.* notebook page.                                                                       *
.*--------------------------------------------------------------------------------------*
:h2 res=&DDID_PAGE4..Physical Desktop Settings
...
just switch to the :link reftype=hd res=&DDID_PAGE10..<Spy>:elink. notebook page,
...
.* page.                                                                                *
.*--------------------------------------------------------------------------------------*
:h2 res=&DDID_PAGE5..General PC/2 Settings
...
:link reftype=hd res=&ID_TRAPINFO..<PC/2 trap/bug diagnostics>:elink.,
...
:link reftype=hd res=&ID_COMPATIBILITY..<BOOTOS2>:elink..
:ewarning.
...
.* page.                                                                                *
.*--------------------------------------------------------------------------------------*
:h2 res=&DDID_PAGE6..SmartIcons Settings
...
.* page                                                                                 *
.*--------------------------------------------------------------------------------------*
:h2 res=&DDID_PAGE7..PC/2 Security Settings
...
:link reftype=hd res=&LDID_LOCKUPDIALOG..<Lockup dialog>:elink.
...
that is the :link reftype=hd res=&ID_DESKTOPDIALOG..<Desktop Configuration
dialog>:elink., the :link reftype=hd res=&ID_CONFIGDIALOG..<Setup dialog>:elink. and the
:link reftype=hd res=&ID_OVERVIEWHELP..<Exit PC/2>:elink. function.
Prior to getting access to these Menuentries, you have to enter the Access Password
in the :link reftype=hd res=&LDID_PASSWORDDIALOG..<Lockup dialog>:elink. first.
...
:link reftype=hd res=&PIID_PAGE3..<Style>:elink. notebook page (of the Program
Installation dialog).
:eul.
...
Once the :link reftype=hd res=&LDID_PASSWORDDIALOG..Password Dialog:elink. is
...
:link reftype=hd res=&ID_DESKTOPDIALOG..<Desktop Configuration dialog>:elink.,
the :link reftype=hd res=&ID_CONFIGDIALOG..<Setup dialog>:elink. and the
:link reftype=hd res=&ID_OVERVIEWHELP..<Exit PC/2>:elink. with the :hp9.Security
Password:ehp9.
...
.* notebook page 1                                                                      *
.*--------------------------------------------------------------------------------------*
:h2 res=&DDID_PAGE8A..Managing Environment Spaces
:p.This and the :link reftype=hd res=&DDID_PAGE8B..<next page>:elink. allow you to
...
:link reftype=hd res=&PIID_PAGE6..<Environment Settings>:elink. notebook page,
...
:link reftype=hd res=&PIID_PAGE6..<Environment Settings>:elink. page.
...
:link reftype=hd res=&DDID_PAGE8B..<next notebook page>:elink..
:dl tsize=12 break=fit.
:dthd.:hp4.Control&colon.
:ddhd.Description&colon.:ehp4.
...
.* notebook page 2                                                                      *
.*--------------------------------------------------------------------------------------*
:h2 res=&DDID_PAGE8B..Defining an Environment Space
:p.This page allows you to edit the details of an Environment Space.
Click :link reftype=hd res=&DDID_PAGE8A..<here>:elink. to switch to the first page.
...
.* page                                                                                 *
.*--------------------------------------------------------------------------------------*
:h2 res=&DDID_PAGE9..Online Registration (Automatic Update capability)
...
.* page                                                                                 *
.*--------------------------------------------------------------------------------------*
:h2 res=&DDID_PAGE10..Spying a window's details
...
:p.For example, in the :link reftype=hd res=&PIID_PAGE4..<Hotkey Settings>:elink. dialog
...
for :link reftype=hd res=&DDID_PAGE1B..<Hardware Panning>:elink. and for
:link reftype=hd res=&PIID_PAGE3..<Titlebar Smarticons>:elink..
:dl tsize=12 break=fit.
:dthd.:hp4.Control&colon.
:ddhd.Description&colon.:ehp4.
...
:link reftype=hd res=&DDID_PAGE2..<Overview Window Settings>:elink. to customize
...
the Overview window must be in :link reftype=hd res=&DDID_PAGE1A..Uncolored:elink.
...
:link reftype=hd res=&DDID_PAGE5..<General Settings>:elink. notebook page.
...
:link reftype=hd res=&DDID_PAGE5..<General Settings>:elink. notebook page via APM
requests.
...
system.
Select the :link reftype=hd res=&DDID_PAGE7..<Lockup PC/2 Settings>:elink. dialog
...
:link reftype=hd res=&ID_TRAPINFO..<PC/2 hang/trap/bug diagnostics>:elink.
...
:p.:link reftype=hd res=&ID_OVERVIEWHELP..<Backward>:elink.
                                :link reftype=hd res=&ID_PC2SWITCHWINDOW..<Forward>:elink.
...
.*--------------------------------------------------------------------------------------*
.****************************************************************************************
:h1 res=&ID_PC2SWITCHWINDOW..PC/2's QuickSwitch Window
:p.When :link reftype=hd res=&DDID_PAGE3..<enabled>:elink.,
...
:p.:link reftype=hd res=&ID_PC2SPOOLERWINDOW..<Backward>:elink.
                                :link reftype=hd res=&ID_PC2SESSIONWINDOW..<Forward>:elink.
...
.*--------------------------------------------------------------------------------------*
.****************************************************************************************
:h1 res=&ID_PC2SESSIONWINDOW..PC/2's SessionBar Window
:p.PC/2 supports the :link reftype=hd res=&DDID_PAGE1B..<SessionBar>:elink. window, which
...
:link reftype=hd res=&DDID_PAGE1B..<Virtual Desktop Settings Page 2>:elink.
notebook page.
...
:link reftype=hd res=&DDID_PAGE3..<SessionBar Settings>:elink. page, the current
...
:link reftype=hd res=&ID_OVERVIEWHELP..<PC/2 debugging support>:elink..
:ul compact.
:li.Dump PC/2 process
:li.Dump W-Thread
:li.Dump I-Thread
:eul.
:edl.
:p.:link reftype=hd res=&ID_PC2SWITCHWINDOW..<Backward>:elink.
...
:h1 res=&LDID_LOCKUPDIALOG..Lockup OS/2 Help
:p.PC/2 can be configured protect access to your workstation by a
:link reftype=hd res=&DDID_PAGE7..<Lockup Password>:elink..
...
:h1 res=&LDID_PASSWORDDIALOG..Security Password Help
:p.PC/2 can be configured to proctect access to critical Menucontrols of its Popup Menu,
that is the :link reftype=hd res=&ID_DESKTOPDIALOG..<Desktop Configuration dialog>:elink.,
the :link reftype=hd res=&ID_CONFIGDIALOG..<Setup dialog>:elink. and the
:link reftype=hd res=&ID_OVERVIEWHELP..<Exit PC/2>:elink. function, and Menuentries
...
:link reftype=hd res=&PIID_PAGE3..<Style>:elink. notebook page.
...
:edl.
:p.:link reftype=hd res=&ID_PC2SWITCHWINDOW..<Backward>:elink.
                                :link reftype=hd res=&ID_BUGS..<Forward>:elink.
...
:h1 res=&ID_BUGS..PC/2's known problems
:p.This section provides information about known bugs and problems of PC/2.
You may also see some more information about the :link reftype=hd res=&ID_TECHINFO..<technical
...
:link reftype=hd res=&ID_ABOUTDIALOG..<E-Mail>:elink. to the author.
:p.:link reftype=hd res=&ID_BUGS..<Backward>:elink.
                                :link reftype=hd res=&ID_FAQ1..<Forward>:elink.

:h2 res=&HELP_CREATEWINDOW..Help for resource problem
...
windows.
:p.Please refer also to the :link reftype=hd res=&ID_ERRORHELP..<general hints>:elink.
...
Please refer to the :link reftype=hd res=&ID_TRAPINFO..<PC/2 diagnostics>:elink.
...
:link reftype=hd res=&ID_DESKTOPDIALOG..<Desktop>:elink. configuration data,
PC/2 will create this file and use it for future invocations.
:p.Please refer also to the :link reftype=hd res=&ID_ERRORHELP..<general hints>:elink.
about error messages.

:h2 res=&HELP_PC2ENV..Help for accessing PC2.ENV
...
:link reftype=hd res=&DDID_PAGE8A..<Environment Spaces>:elink., PC/2 will create
...
:h2 res=&HELP_PC2RUNNINGASPROTSHELL..Help for PC/2 as PROTSHELL process
...
:h2 res=&HELP_PC2BADPASSWORD..Help for PC/2's Security features
...
:h2 res=&HELP_PC2REBOOT..Help for automatic shutdown and reboot
...
:link reftype=hd res=&DDID_PAGE5..<General Settings>:elink.
...
:h2 res=&HELP_PC2TIMER..Help for PC/2's internal timer
...
:h2 res=&HELP_ICONCACHE..Help for caching icons for PC/2's Popup Menu
...
:p.:link reftype=hd res=&DDID_PAGE1A..<Click here>:elink. to select some more
information about using icons in the Popup Menu.
:p.Please refer also to the :link reftype=hd res=&ID_ERRORHELP..<general hints>:elink.
about error messages.

:h2 res=&HELP_POPUPMENU..Help for updating PC/2's Popup Menu
...
:link reftype=hd res=&ID_GENERALHELP..<Commandline option>:elink.) before saving the
adjustments you made to your configuration file.
:p.Please refer also to the :link reftype=hd res=&ID_ERRORHELP..<general hints>:elink.
about error messages.

:h2 res=&HELP_SESSIONBAR..Help for creating or modifying PC/2's SessionBar
...
:h2 res=&HELP_QUICKSWITCH..Help for creating PC/2's QuickSwitch window
...
:h2 res=&HELP_POWERDOWN..Help for APM suspend/power off
...
verify at the :link reftype=hd res=&DDID_PAGE5..<General Settings>:elink.
help how to install this device driver.
:ul compact.
...
:h2 res=&HELP_PC2CLEANUP..Help for cleanup processing
...
:h2 res=&HELP_PC2BACKUP..Help for backing up PC/2 configuration
...
that have been specified by :link reftype=hd res=&ID_GENERALHELP..<commandline options>:elink..
...
:h2 res=&HELP_PC2ALIVE..Help for PC/2 thread problems
...
:h2 res=&HELP_PC2STATUS..Help for PC/2 Online Automatic Update status
...
:h2 res=&HELP_PC2NEWS..Help for PC/2 Automatic Update news retrieval
...
:h2 res=&HELP_PC2UPDATE..Help for PC/2 Automatic Update file updates
...
:h2 res=&HELP_PC2NETDLL..Help for PC2NET.DLL
...
:h2 res=&HELP_BUBBLEHELP..Help for creating PC/2's BubbleHelp window
...
:h2 res=&HELP_PC2TRAP..Help for PC/2 problem determination
:p.PC/2 has detected that :hp9.PC2.TRP:ehp9. has been updated recently (or to be exact since
the last time PC/2 has read it).
This file is used for :link reftype=hd res=&ID_TRAPINFO..<PC/2 hang/trap/bug diagnostics>:elink..
...
:ol compact.
:li.Display PC/2's :link reftype=hd res=&ID_ABOUTDIALOG..<About Dialog>:elink..
or use the :link reftype=hd res=&ID_TRAPINFO..<BLDLEVEL>:elink.. command to find out
...
:link reftype=hd res=&ID_ABOUTDIALOG..<here>:elink..
...
:h1 res=&ID_FAQ1..Help Questions &amp. Answers (part 1)
...
:p.:link reftype=hd res=&ID_ERRORHELP..<Backward>:elink.
                                :link reftype=hd res=&ID_FAQ2..<Forward>:elink.

:h1 res=&ID_FAQ2..Help Questions &amp. Answers (part 2)
:p.
:font facename=Courier size=9x5.
:xmp.
.im ..\PC2-2.FAQ
:exmp.
:font facename=default size=0x0.
:p.:link reftype=hd res=&ID_FAQ1..<Backward>:elink.
                                :link reftype=hd res=&ID_FAQ3..<Forward>:elink.

:h1 res=&ID_FAQ3..Help Questions &amp. Answers (part 3)
:p.
:font facename=Courier size=9x5.
:xmp.
.im ..\PC2-3.FAQ
:exmp.
:font facename=default size=0x0.
:p.:link reftype=hd res=&ID_FAQ2..<Backward>:elink.
                                :link reftype=hd res=&ID_TRAPINFO..<Forward>:elink.
...
:h1 res=&ID_TRAPINFO..PC/2 hang/trap/bug diagnostics
...
:link reftype=hd res=&ID_OVERVIEWHELP..<Overview Window>:elink. Popup Menu,
...
the very useful :link reftype=hd res=&ID_COMPATIBILITY..<PMPRINTF>:elink. IBM EWS
package.
...
:link reftype=hd res=&DDID_PAGE5..<General PC/2 Settings>:elink. notebook page.
...
:ewarning.
.* You may also fill in the :link reftype=hd res=&ID_SURVEY..<PC/2 Survey>:elink. to give
.* me some more general feedback.
:p.:link reftype=hd res=&ID_FAQ3..<Backward>:elink.
                                :link reftype=hd res=&ID_TECHINFO..<Forward>:elink.
...
:h1 res=&ID_TECHINFO..PC/2 bug background information
...
can change this.
:eul.
:p.:link reftype=hd res=&ID_TRAPINFO..<Backward>:elink.
                                :link reftype=hd res=&ID_HELP..<Forward>:elink.
.*                                 :link reftype=hd res=&ID_SURVEY..<Forward>:elink.
